...
現況確認: **2026年9月17日**。利用者向けの概要は[機能と実装状況](features.md)、操作入口は[使い方](daily-work.md)、URLは[画面一覧](screen-transition-list.md)を参照してください。

[9月17日の変更仕様](spec-improvements-2026-09-17.md)に、保護者入力・出欠集計・健診訂正・結果閲覧権限などの追加動作とDB更新をまとめています。
