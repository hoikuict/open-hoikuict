...
[2026年9月15日の仕様変更](spec-improvements-2026-09-15.md)に、職員認証修正、ターミナル全画面、Googleカレンダー取込、保護者情報への導線、タイムライン、議事録出力をまとめています。
...
| [データ移行コンバーター](migration-converter.md) | 実装済み（初版） | 既存CSV・Excelの列対応、家庭・園児の分割、保護者の行まとめ、変換設定の再利用。単体版とアプリ内画面 |
