...
初版の検証対象コード：JSON入力に対応した修正版 `e614d9a8872907681b27c1677274cc09255a137b`。新規導入時はこのSHAを無条件に採用せず、[変更履歴](history.md)で必要な機能を含む版を確認して固定してください。
